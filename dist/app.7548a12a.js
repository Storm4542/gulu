...
//
//
        var $34ad46 = exports.default || module.exports;
      
      if (typeof $34ad46 === 'function') {
        $34ad46 = $34ad46.options;
      }
    
        /* template */
        Object.assign($34ad46, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$34ad46', $34ad46);
          } else {
            api.reload('$34ad46', $34ad46);
          }
        }
...
exports.default = {
    ...
    props: { //props的写法,控制性更强
        ...
        btntype: {
            type: String,
            validate: function validate(value) {
                ['primary', 'success', 'warning', 'danger'].map(function (className) {
                    if (value === className) {
                        return true;
                    }
                    return false;
    ...
    computed: {
        ...
        var $a56194 = exports.default || module.exports;
      
      if (typeof $a56194 === 'function') {
        $a56194 = $a56194.options;
      }
    
        /* template */
        Object.assign($a56194, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a56194', $a56194);
          } else {
            api.reload('$a56194', $a56194);
          }
        }
...
},{"vue":"node_modules/vue/dist/vue.common.js","./icon.vue":"src/icon.vue","./svg":"src/svg.js","_css_loader":"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js"}],"src/button-group.vue":[function(require,module,exports) {
"use strict";
...
exports.default = {
    name: "button-group",
    mounted: function mounted() {
        //当button-group出现在页面的时候,检测用户是不是写错了
        ...
        var $11e18f = exports.default || module.exports;
      
      if (typeof $11e18f === 'function') {
        $11e18f = $11e18f.options;
      }
    
        /* template */
        Object.assign($11e18f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$11e18f', $11e18f);
          } else {
            api.reload('$11e18f', $11e18f);
          }
        }
...
//
//
        var $3e8636 = exports.default || module.exports;
      
      if (typeof $3e8636 === 'function') {
        $3e8636 = $3e8636.options;
      }
    
        /* template */
        Object.assign($3e8636, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$3e8636', $3e8636);
          } else {
            api.reload('$3e8636', $3e8636);
          }
        }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$7ac96d', $7ac96d);
          } else {
            api.reload('$7ac96d', $7ac96d);
          }
        }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$95c97b', $95c97b);
          } else {
            api.reload('$95c97b', $95c97b);
          }
        }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b21282', $b21282);
          } else {
            api.reload('$b21282', $b21282);
          }
        }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d69465', $d69465);
          } else {
            api.reload('$d69465', $d69465);
          }
        }
...
},{"_css_loader":"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/sider.vue":[function(require,module,exports) {
"use strict";
...
exports.default = {
    ...
    methods: {
        ...
        var $a42602 = exports.default || module.exports;
      
      if (typeof $a42602 === 'function') {
        $a42602 = $a42602.options;
      }
    
        /* template */
        Object.assign($a42602, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a42602', $a42602);
          } else {
            api.reload('$a42602', $a42602);
          }
        }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$438b6d', $438b6d);
          } else {
            api.reload('$438b6d', $438b6d);
          }
        }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e75ce2', $e75ce2);
          } else {
            api.reload('$e75ce2', $e75ce2);
          }
        }
...
},{"_css_loader":"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/toast.vue":[function(require,module,exports) {
'use strict';
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$700335', $700335);
          } else {
            api.reload('$700335', $700335);
          }
        }
...
function createToast(_ref) {
    ...
    var construstor = vue.extend(_toast2.default);
    var toast = new construstor({ propsData: propsData }); //创建 toast实例
...
//
  ...
  return _c(
    "div",
    {
      staticClass: "tabs",
      class: ((_obj = {}),
      (_obj["direction-" + _vm.directionClass] = true),
      _obj)
    },
    [_vm._t("default")],
    2
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4e098d', $4e098d);
          } else {
            api.reload('$4e098d', $4e098d);
          }
        }
...
},{"vue":"node_modules/vue/dist/vue.common.js","_css_loader":"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js"}],"src/tabs-head.vue":[function(require,module,exports) {
"use strict";
...
exports.default = {
  ...
  return _c(
    ...
    [
      _vm._t("default"),
      _vm._v(" "),
      _c("div", { staticClass: "actions-wrapper" }, [_vm._t("action")], 2)
    ],
    2
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$cc1544', $cc1544);
          } else {
            api.reload('$cc1544', $cc1544);
          }
        }
...
},{"_css_loader":"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/tabs-body.vue":[function(require,module,exports) {
"use strict";
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$90338b', $90338b);
          } else {
            api.reload('$90338b', $90338b);
          }
        }
...
},{"_css_loader":"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/tabs-item.vue":[function(require,module,exports) {
'use strict';
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e8acb9', $e8acb9);
          } else {
            api.reload('$e8acb9', $e8acb9);
          }
        }
...
},{"_css_loader":"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/tabs-pane.vue":[function(require,module,exports) {
'use strict';
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e7955d', $e7955d);
          } else {
            api.reload('$e7955d', $e7955d);
          }
        }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ff3dc1', $ff3dc1);
          } else {
            api.reload('$ff3dc1', $ff3dc1);
          }
        }
...
},{"_css_loader":"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/collapse.vue":[function(require,module,exports) {
'use strict';
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$de0d52', $de0d52);
          } else {
            api.reload('$de0d52', $de0d52);
          }
        }
...
},{"vue":"node_modules/vue/dist/vue.common.js","_css_loader":"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js"}],"src/collapse-item.vue":[function(require,module,exports) {
'use strict';
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$1ff19a', $1ff19a);
          } else {
            api.reload('$1ff19a', $1ff19a);
          }
        }
...
_vue2.default.component('g-collapse', _collapse2.default);
_vue2.default.component('g-collapse-item', _collapseItem2.default);

_vue2.default.use(_plugin2.default); //执行install方法
...
new _vue2.default({
    ...
    methods: {
        ...
        clickSuccess: function clickSuccess(message, event) {
            var btnElement = event.currentTarget;
            var iconElement = event.currentTarget.querySelector('use');
            var iconname = iconElement.getAttribute('xlink:href');
            var svgElement = event.currentTarget.querySelector('svg');
...
},{"vue":"node_modules/vue/dist/vue.common.js","./button":"src/button.vue","./icon":"src/icon.vue","./button-group":"src/button-group.vue","./input":"src/input.vue","./row":"src/row.vue","./col":"src/col.vue","./layout":"src/layout.vue","./content":"src/content.vue","./sider":"src/sider.vue","./header":"src/header.vue","./footer":"src/footer.vue","./toast":"src/toast.vue","./plugin":"src/plugin.js","./tabs":"src/tabs.vue","./tabs-head":"src/tabs-head.vue","./tabs-body":"src/tabs-body.vue","./tabs-item":"src/tabs-item.vue","./tabs-pane":"src/tabs-pane.vue","./popover":"src/popover.vue","./collapse":"src/collapse.vue","./collapse-item":"src/collapse-item.vue"}],"node_modules/_parcel-bundler@1.9.7@parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/app.7548a12a.map